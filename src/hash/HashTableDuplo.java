...
/**
 * HashTableDuplo
 * Implementa tabela hash usando rehashing duplo (double hashing).
 * Cada colisão é contada, e gaps são calculados para análise.
 */
public class HashTableDuplo implements HashTable {
    ...
    /**
     * Segunda função hash: garante passo > 0 e menor que tamanho da tabela.
     * Evita loops infinitos e distribui melhor os elementos.
     */
    ...
    /**
     * Insere um registro usando hash duplo.
    ...
    public void inserir(Registro r) {
        ...
        if (i < tamanho) tabela[pos] = r; // insere se houver espaço
    }

    /**
     * Busca um registro usando hash duplo.
     */
    @Override
